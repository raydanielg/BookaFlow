...
export default function SettingsPage() {
  ...
  const profileUrl = `bookmiadi.com/@${data.slug}`
  const bookingUrl = `bookmiadi.com/book/${data.slug}`
          ...
          <Card className="gap-0 p-6">
            ...
            <div className="grid gap-4 pt-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <Input name="canonicalUrl" defaultValue={data.seo?.canonicalUrl || ""} placeholder="https://bookmiadi.com/@your-slug" />
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 rounded-lg border border-border bg-muted/30 p-4">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <p className="text-xs text-green-700">bookmiadi.com/@{data.slug}</p>
