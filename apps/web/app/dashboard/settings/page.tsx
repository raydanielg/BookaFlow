    ...
    <>
      ...
      <div className="flex items-center gap-1 rounded-lg border border-border p-1 w-fit">
        {(["profile", "details", "seo", "booking"] as const).map((tab) => (
          <button
            ...
            className={`rounded-lg px-5 py-2.5 text-sm font-medium transition-colors capitalize ${
      ...
      {activeTab === "profile" && (
        <form onSubmit={saveProfile} className="flex flex-col gap-6">
          ...
          <Card className="gap-0 p-7">
            ...
            <div className="grid gap-4 pt-4">
              <div className="flex items-center gap-2">
                ...
                <Button type="button" variant="outline" onClick={() => { navigator.clipboard.writeText(`https://${profileUrl}`); toast.add({ type: "success", title: "Copied!" }) }}>
              ...
              <div className="flex items-center gap-2">
                ...
                <Button type="button" variant="outline" onClick={() => { navigator.clipboard.writeText(`https://${bookingUrl}`); toast.add({ type: "success", title: "Copied!" }) }}>
                  <HugeiconsIcon icon={Copy01Icon} className="size-4" />
                </Button>
          ...
          <Card className="gap-0 p-7">
            ...
            <div className="grid gap-5 pt-5 sm:grid-cols-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <select name="type" defaultValue={data.type} className="flex h-11 w-full rounded-lg border border-input bg-background px-3.5 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-ring">
              ...
              <div className="flex flex-col gap-2 sm:col-span-2">
                <Label className="text-sm font-medium">Short Description (max 200 chars)</Label>
              ...
              <div className="flex flex-col gap-2 sm:col-span-2">
                ...
                <textarea name="description" defaultValue={data.description || ""} rows={4} className="flex w-full rounded-lg border border-input bg-background px-3.5 py-3 text-base focus:outline-none focus:ring-2 focus:ring-ring" placeholder="Tell customers about your business..." />
              </div>
            </div>
          </Card>
          ...
          <Card className="gap-0 p-7">
            ...
            <div className="grid gap-5 pt-5 sm:grid-cols-2">
              <div className="flex flex-col gap-2">
                <Label className="text-sm font-medium">Profile Page</Label>
                <select name="profileVisibility" defaultValue={data.profileVisibility} className="flex h-11 w-full rounded-lg border border-input bg-background px-3.5 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-ring">
              ...
              <div className="flex flex-col gap-2">
                ...
                <select name="bookingVisibility" defaultValue={data.bookingVisibility} className="flex h-11 w-full rounded-lg border border-input bg-background px-3.5 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-ring">
          ...
          <div className="flex justify-end">
            <Button type="submit" size="lg" loading={saving} className="shadow-sm shadow-primary/20 transition-all duration-300 hover:shadow-md hover:shadow-primary/25 active:scale-[0.98]">
      ...
      {activeTab === "details" && (
        <form onSubmit={saveDetails} className="flex flex-col gap-6">
          ...
          <Card className="gap-0 p-7">
            ...
            <div className="grid gap-4 pt-4">
              <div className="flex flex-col gap-2">
                ...
                <textarea name="bio" defaultValue={data.bio || ""} rows={5} className="flex w-full rounded-lg border border-input bg-background px-3.5 py-3 text-base focus:outline-none focus:ring-2 focus:ring-ring" placeholder="Write a detailed bio about yourself, your career, achievements, and what makes you unique..." />
              </div>
              ...
              <div className="flex flex-col gap-2">
                <Label className="text-sm font-medium">Specialties / Expertise (comma separated)</Label>
          ...
          <Card className="gap-0 p-7">
            ...
            <div className="grid gap-4 pt-5">
              ...
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={`new-cert-${i}`} className="grid gap-3 sm:grid-cols-3">
          ...
          <div className="flex justify-end">
            <Button type="submit" size="lg" loading={detailsSaving} className="shadow-sm shadow-primary/20 transition-all duration-300 hover:shadow-md hover:shadow-primary/25 active:scale-[0.98]">
              <HugeiconsIcon icon={CheckmarkCircle01Icon} className="size-4" />
      ...
      {activeTab === "seo" && (
        <form onSubmit={saveSEO} className="flex flex-col gap-6">
          <Card className="gap-0 p-7">
            ...
            <div className="grid gap-4 pt-4">
              <div className="flex flex-col gap-2">
                <Label className="text-sm font-medium">SEO Title (max 60 chars)</Label>
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea name="metaDescription" maxLength={160} rows={2} defaultValue={data.seo?.metaDescription || ""} className="flex w-full rounded-lg border border-input bg-background px-3.5 py-3 text-base focus:outline-none focus:ring-2 focus:ring-ring" placeholder="Book services at..." />
              </div>
              <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-end">
            <Button type="submit" size="lg" loading={seoSaving} className="shadow-sm shadow-primary/20 transition-all duration-300 hover:shadow-md hover:shadow-primary/25 active:scale-[0.98]">
              <HugeiconsIcon icon={CheckmarkCircle01Icon} className="size-4" />
              Save SEO
            </Button>
          </div>
        ...
        <form onSubmit={saveBookingSettings} className="flex flex-col gap-6">
          <Card className="gap-0 p-7">
            ...
            <div className="grid gap-5 pt-5 sm:grid-cols-2">
              ...
              <div className="flex flex-col gap-2">
                <Label className="text-sm font-medium">Cancellation Deadline (hours before)</Label>
                <Input name="cancellationDeadlineHours" type="number" min={0} defaultValue={data.bookingSettings?.cancellationDeadlineHours ?? 6} />
              </div>
              <div className="flex flex-col gap-2">
                <Label className="text-sm font-medium">Buffer Between Appointments (minutes)</Label>
              ...
              <div className="flex flex-col gap-2">
                ...
                <select name="paymentMode" defaultValue={data.bookingSettings?.paymentMode ?? "PAY_AT_VENUE"} className="flex h-11 w-full rounded-lg border border-input bg-background px-3.5 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-ring">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              {[
                ...
                <label key={toggle.key} className="flex cursor-pointer items-center gap-3 rounded-xl border border-border p-4 hover:bg-muted/30 transition-colors">
                  <input type="checkbox" name={toggle.key} defaultChecked={toggle.default} className="size-5 rounded border-input accent-primary" />
          ...
          <div className="flex justify-end">
            <Button type="submit" size="lg" loading={bookingSaving} className="shadow-sm shadow-primary/20 transition-all duration-300 hover:shadow-md hover:shadow-primary/25 active:scale-[0.98]">
              <HugeiconsIcon icon={CheckmarkCircle01Icon} className="size-4" />
              Save Booking Rules
            </Button>
          </div>
